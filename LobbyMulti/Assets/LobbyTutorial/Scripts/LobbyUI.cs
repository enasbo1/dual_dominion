...
public class LobbyUI : MonoBehaviour {
    ...
    {
        if(playerCountText.text.StartsWith("1")) Debug.Log("TestScene"); // SceneManager.LoadScene("TestScene");
        else if(playerCountText.text.StartsWith("2")) Debug.Log("MainScene"); // SceneManager.LoadScene("MainScene");
    }
