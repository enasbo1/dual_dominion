...
{
    public class HasteSpell3 : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            _haste3.AddSpellListener(_ => OnSpellCast());
            _haste3.AddSpellFailureListener(_ => OnSpellCastAsFailure());
        ...
        {
            _timer = 35f;
            footMoveScript.movementSpeed = _initialValue * 4f;
            effectRenderer.material = effectMaterial;
            _haste3.isInCast = true;
        }
        
        private void OnSpellCastAsFailure()
        {
            _timer = 8f;
            footMoveScript.movementSpeed = _haste.isInCast ? _initialValue * 0.4f : _initialValue * 2f;
