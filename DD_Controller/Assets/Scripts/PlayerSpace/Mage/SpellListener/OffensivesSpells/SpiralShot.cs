...
namespace PlayerSpace.Mage.SpellListener
{
    public class SpiralShot : MonoBehaviour
    {
        ...
        private void Start()
        {
            _spiralShot = spellManager.GetSpellByName("Spiral Shot");
            ...
            _spiralShot.AddSpellListener(_ => OnSpellCast());
            _spiralShot.AddSpellFailureListener(_ => OnSpellCastedAsFailure());
        }
        ...
        private void FixedUpdate()
        {
            ...
            groupOfTheSpellToCast.bullets.ForEach(bullet => bullet.gameObject.SetActive(spellManager.spellToCast.id == _spiralShot.id));
        }
