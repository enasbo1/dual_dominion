...
namespace Shared
{
    public class WalkerReferencer : PrefabReferencer<WalkerDdDealer, WalkerEnum, MonsterVariants>
    {
    }

    public class PrefabReferencer<TDealer, TEnum, TVariant> : MonoBehaviour where TDealer : Dealer<TEnum, TVariant>
        where TEnum : Enum
        where TVariant : Enum
    {
